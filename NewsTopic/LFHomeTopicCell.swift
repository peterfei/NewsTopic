...
class LFHomeTopicCell: UITableViewCell {
    
    var filterWords: [LFFilterWord]?
    
    var closeButtonClosure: ((filterWords: [LFFilterWord])->())?
    ...
    lazy var stickLabel: UIButton = {
        ...
        stickLabel.setTitleColor(LFColor(241, g: 91, b: 94, a: 1.0), forState: .Normal)
        stickLabel.layer.borderColor = LFColor(241, g: 91, b: 94, a: 1.0).CGColor
